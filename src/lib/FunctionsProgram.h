...
bool       prgReadColonSepListVectorInt  (std::ifstream &, MyString &, List< VectorWulf<int> > &);
bool       prgReadLnBrkSepListVectorInt  (std::ifstream &, MyString &, List< VectorWulf<int> > &);
bool       prgReadLnBrkSepListVectorDbl  (std::ifstream &, MyString &, List< VectorWulf<double> > &);
//void       prgTest                       (void);
